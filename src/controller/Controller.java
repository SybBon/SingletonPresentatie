...
public class Controller {
    public static void main(String[] args) {
        ...
        Singleton sharedBasket2 = new Singleton();
        Singleton washand = new Singleton();
        Singleton smurfenHouse = new Singleton();
        smurfenHouse.addLaundry("Smurf Muts");
        washand.addLaundry("Sokken");
...
//        Singleton washand = Singleton.getWasmand();
//        Singleton smurfenHouse = Singleton.getWasmand();
//        smurfenHouse.addLaundry("Smurf Muts");
//        washand.addLaundry("Sokken");
//        sharedBasket1.addLaundry("T-shirt");
//        sharedBasket2.addLaundry("Jeans");
...
//        slaapkamerMand.addLaundry("Trui");
